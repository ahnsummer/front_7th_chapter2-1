        ...
        <div className="p-4">
          ...
          <div>
            ...
            <h1 className="text-xl font-bold text-gray-900 mb-3">
              PVC 투명 젤리 쇼핑백 1호 와인 답례품 구디백 비닐 손잡이 미니 간식
              선물포장
            </h1>
            {/* 평점 및 리뷰 */}
            ...
            {/* 재고 */}
            <div className="text-sm text-gray-600 mb-4">재고 107개</div>
            {/* 설명 */}
            <div className="text-sm text-gray-700 leading-relaxed mb-6">
              PVC 투명 젤리 쇼핑백 1호 와인 답례품 구디백 비닐 손잡이 미니 간식
              선물포장에 대한 상세 설명입니다. 브랜드의 우수한 품질을 자랑하는
          ...
          <div className="grid grid-cols-2 gap-3 responsive-grid">
            ...
            >
              ...
              <h3 className="text-sm font-medium text-gray-900 mb-1 line-clamp-2">
                샷시 풍지판 창문 바람막이 베란다 문 틈막이 창틀 벌레 차단 샤시
                방충망 틈새막이
              </h3>
